{lib, ...}: {
  dconf.settings = with lib.gvariant; {
    "org/gnome/desktop/wm/keybindings" = {
      ...
      switch-group-backward = ["<Alt><Super>Above_Tab"]; # Reverse switch windows of an application
      switch-applications = ["<Alt>Tab"]; # Switch applications
      switch-applications-backward = ["<Alt><Super>Tab"]; # Reverse switch applications
      ...
      switch-panels-backward = ["<Shift><Ctrl><Alt>Tab"]; # Reverse switch system Ctrls

      cycle-group = []; # Switch windows of an app directly
      cycle-group-backward = []; # Reverse switch windows of an app directly
      cycle-windows = ["<Alt>Escape"]; # Switch windows directly
      cycle-windows-backward = ["<Shift><Alt>Escape"]; # Reverse switch windows directly
